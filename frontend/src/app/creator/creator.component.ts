...
export class CreatorComponent implements OnInit {
  ...
  pregledajAnkete(){
    this.router.navigate(['/kreatorPregledAnketa']);
  }

  pregledajTestove(){
    this.router.navigate(['/kreatorPregledTestova']);
  }

  obrisiTestove(){
    this.router.navigate(['/kreatorBrisanjeTestova']);
  }

  obrisiAnkete(){
    this.router.navigate(['/kreatorBrisanjeAnketa']);
  }

  kreirajTestove(){
    this.router.navigate(['/kreatorKreiranjeTestova']);
  }

  kreirajAnkete(){
    this.router.navigate(['/kreatorKreiranjeAnketa']);
  }

  kreirajTestoveJSON(){
    this.router.navigate(['/testJSON']);
  }

  kreirajAnketeJSON(){
    this.router.navigate(['/anketaJSON']);
  }

  rezultatiTestova(){
    this.router.navigate(['/pregledRezultataTestova']);
  }
  
  rezultatiAnketa(){
    this.router.navigate(['/pregledRezultataAnketa']);
  }
